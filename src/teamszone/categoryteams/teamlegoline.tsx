...
const TeamLegoLine = () => {
  ...
  const category = categories.find(cat => cat.name === 'Lego Line')
  const categoryTeams = allTeams.filter(team => team.categoryName?.trim() === 'Lego Line')
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            {category?.description || 'LEGO-based line follower competition teams'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-4 text-center">
            <div className="text-2xl font-bold text-blue-600 mb-1">LEGO</div>
        ...
        <div className="mb-8">
          {categoryTeams.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-xl shadow-sm border border-blue-100">
              ...
              <p className="text-slate-600 mb-6">Be the first to register a team in the Lego Line category!</p>
              <Link
                to="/contact"
                ...
                <article key={team.id} className="bg-white rounded-xl shadow-sm border border-blue-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-slate-500">Lego Line</span>
                    </div>
                  </div>
                </article>
              ))}
        ...
        {category && (
          <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
            <h3 className="text-lg font-semibold text-slate-800 mb-3">About Lego Line Competition</h3>
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              ...
              <div className="flex items-center text-slate-600">
                ...
                <Link to={`/rules/legoline`} className="text-blue-600 hover:text-blue-700">Competition Rules</Link>
              </div>
            </div>
          </div>
        )}
