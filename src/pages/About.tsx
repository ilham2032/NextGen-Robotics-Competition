    ...
    <main className='min-h-screen bg-white text-slate-900 overflow-hidden'>
      ...
      <div className='relative max-w-6xl mx-auto px-6 pt-28 pb-24'>
        <header className='text-center mb-14'>
          <h1 className='text-5xl md:text-6xl font-display font-extrabold text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-cyan-500 to-indigo-600 animate-fade-in-up'>About NextGen Robotics</h1>
          <p className='mt-4 text-lg md:text-xl text-slate-700 max-w-3xl mx-auto leading-relaxed animate-fade-in-up' style={{ animationDelay: '0.15s' }}>
        ...
        <div className='mb-12 grid gap-8 md:grid-cols-2 items-center'>
          <div className='rounded-3xl overflow-hidden shadow-2xl transform transition duration-500 hover:-translate-y-2 bg-linear-to-r from-blue-500 to-indigo-500 animate-fade-in-left' style={{ animationDelay: '0.2s' }}>
        ...
        <section className='grid gap-6 md:grid-cols-2 lg:grid-cols-2'>
          <article className='relative rounded-2xl border border-blue-200/80 bg-white/80 backdrop-blur-xl p-6 shadow-lg animate-scale-in' style={{ animationDelay: '0.25s' }}>
          ...
          <article className='relative rounded-2xl border border-blue-200/80 bg-white/80 backdrop-blur-xl p-6 shadow-lg animate-scale-in' style={{ animationDelay: '0.3s' }}>
          ...
          <article className='relative rounded-2xl border border-blue-200/80 bg-white/80 backdrop-blur-xl p-6 shadow-lg animate-scale-in' style={{ animationDelay: '0.35s' }}>
          ...
          <article className='relative rounded-2xl border border-blue-200/80 bg-white/80 backdrop-blur-xl p-6 shadow-lg animate-scale-in' style={{ animationDelay: '0.4s' }}>
