    ...
    <section className='min-h-screen bg-gradient-to-b from-blue-50 to-white px-4 pb-16 pt-24 sm:px-6 sm:pt-28'>
      <div className='mx-auto max-w-6xl'>
        <div className='rounded-3xl bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-600 px-6 py-10 text-white shadow-xl sm:px-10'>
          <p className='text-xs tracking-[0.2em] text-blue-100 uppercase'>NextGen Robotics Competition</p>
          <h1 className='mt-2 text-4xl font-display font-bold sm:text-5xl'>Awards & Prizes</h1>
          <p className='mt-4 max-w-3xl text-blue-100'>
            Every category celebrates innovation, teamwork, and engineering excellence. Top-performing teams will receive
            cash prizes and recognition on the main stage.
          </p>
        </div>

        <div className='mt-8 grid gap-5 md:grid-cols-3'>
          <article className='rounded-2xl border border-yellow-200 bg-white p-6 shadow-sm'>
            <p className='text-sm font-semibold text-yellow-600 uppercase'>1st Place Winner</p>
            <h2 className='mt-2 text-4xl font-bold text-blue-900'>$500</h2>
            <p className='mt-2 text-sm text-slate-600'>Awarded to the champion team in each category.</p>
          </article>

          <article className='rounded-2xl border border-slate-200 bg-white p-6 shadow-sm'>
            <p className='text-sm font-semibold text-slate-600 uppercase'>2nd Place Winner</p>
            <h2 className='mt-2 text-4xl font-bold text-blue-900'>$300</h2>
            <p className='mt-2 text-sm text-slate-600'>Given to the runner-up team in each category.</p>
          </article>

          <article className='rounded-2xl border border-orange-200 bg-white p-6 shadow-sm'>
            <p className='text-sm font-semibold text-orange-600 uppercase'>3rd Place Winner</p>
            <h2 className='mt-2 text-4xl font-bold text-blue-900'>$200</h2>
            <p className='mt-2 text-sm text-slate-600'>Presented to the third best team in each category.</p>
          </article>
        </div>
