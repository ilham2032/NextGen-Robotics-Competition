      ...
      <div className="mx-auto max-w-5xl">
        <div className="rounded-3xl bg-linear-to-r from-blue-700 via-indigo-700 to-blue-900 px-6 py-10 text-white shadow-lg sm:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm text-blue-100 sm:text-base">
            {t('Official rankings and category scoreboards will appear here after referee verification.')}
          </p>
        </div>

        <div className="mt-8 rounded-2xl border border-blue-100 bg-white p-8 text-center shadow-sm">
          <p className="text-lg font-semibold text-slate-800">{t('Standings are not published yet.')}</p>
          <p className="mt-2 text-slate-600">{t('Please check back after match results are finalized.')}</p>
        </div>
      </div>
    </section>
  )
