    ...
    <div className="bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto mt-16 grid max-w-6xl gap-8 px-6 md:px-10 lg:grid-cols-3 lg:px-16">
        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm tracking-wide text-slate-600 uppercase">{t('Expected Participants')}</p>
        </div>
        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
          <p className="text-4xl font-bold text-blue-700">20+</p>
          <p className="mt-2 text-sm tracking-wide text-slate-600 uppercase">{t('Schools and Teams')}</p>
        </div>
        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
          <p className="text-4xl font-bold text-blue-700">2 Days</p>
          <p className="mt-2 text-sm tracking-wide text-slate-600 uppercase">{t('Competition and Exhibition')}</p>
        </div>
      </section>

      <section className="mx-auto mt-16 grid max-w-6xl items-center gap-10 px-6 md:px-10 lg:grid-cols-2 lg:px-16">
        <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          <h2 className="font-display text-4xl font-bold text-slate-900 md:text-5xl">{t('What is NextGen Competition?')}</h2>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/70">
          <h3 className="text-2xl font-semibold text-slate-900">{t('Why Join?')}</h3>
          <ul className="mt-5 space-y-3 text-slate-600">
            <li>- {t('Build practical robotics and coding skills.')}</li>
            <li>- {t('Solve real-world challenges with your team.')}</li>
            <li>- {t('Present your work to judges and industry mentors.')}</li>
            <li>- {t('Connect with a community of young innovators.')}</li>
          </ul>
        </div>
      </section>

      <section className="mx-auto mt-20 max-w-6xl px-6 md:px-10 lg:px-16">
        <h2 className="text-center font-display text-4xl font-bold text-slate-900 md:text-5xl">{t('Our Mission')}</h2>
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="mission-card opacity-0 animate-scale-in" style={{ animationDelay: "0.25s" }}>
            <h3 className="font-poppins text-2xl font-bold text-white">{t('Innovating for Real-World Impact')}</h3>
          ...
          <div className="mission-card opacity-0 animate-scale-in" style={{ animationDelay: "0.45s" }}>
            <h3 className="font-poppins text-2xl font-bold text-white">{t('Inspiring Future Technologists')}</h3>
            <p className="mt-4 font-poppins leading-relaxed text-blue-50">
      ...
      <section className="mx-auto mt-20 max-w-6xl px-6 pb-8 md:px-10 lg:px-16">
        <div className="mb-8 flex items-center justify-between gap-4">
          <h2 className="font-display text-4xl font-bold text-slate-900 md:text-5xl">{t('Categories')}</h2>
      ...
      <section className="mx-auto mt-14 mb-4 max-w-6xl px-6 md:px-10 lg:px-16">
        <div className="rounded-3xl bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 px-8 py-10 text-center text-white shadow-xl">
          <h2 className="font-display text-4xl font-bold md:text-5xl">{t('Ready to Compete?')}</h2>
