  ...
  return (
    <div className="bg-slate-50 text-slate-900">
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-900 px-6 pb-32 pt-28 md:px-10 md:pt-32 lg:px-16">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            <Reveal immediate animation="fade-in-left" delay={0.1}>
              <p className="text-lg font-medium tracking-[0.35em] text-cyan-300 uppercase">
                {t('1st Edition')}
              </p>
            </Reveal>
      ...
      <section className="mx-auto mt-20 grid max-w-6xl items-center gap-12 px-6 md:px-10 lg:grid-cols-2 lg:px-16">
        ...
        <Reveal animation="fade-in-right" delay={0.2}>
