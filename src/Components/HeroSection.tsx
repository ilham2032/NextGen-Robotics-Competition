...
const HeroSection = ({ 
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-slate-950 via-blue-950 to-indigo-900 px-6 pb-24 pt-28 md:px-10 lg:px-16">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2">
        <div className="opacity-0 animate-fade-in-up text-center lg:text-left" style={{ animationDelay: '0.1s' }}>
          ...
          <h1 className="animate-fade-in-left mt-3 bg-linear-to-r from-white via-blue-100 to-cyan-200 bg-clip-text font-display text-5xl leading-tight font-bold text-transparent md:text-7xl" style={{ animationDelay: '0.4s' }}>
            {title}
          </h1>
        ...
        {imageSrc && (
          <div className="relative mx-auto w-full max-w-xl">
            <div className="absolute -inset-6 rounded-[2rem] bg-linear-to-r from-cyan-400/35 via-blue-500/30 to-purple-500/35 blur-2xl" />
            <img
