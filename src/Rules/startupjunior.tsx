...
const StartupJunior = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-blue-700 to-blue-800 py-20">
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <section className="mb-10">
          <h2 className="font-display mb-4 border-b-2 border-blue-500 pb-2 text-3xl font-bold text-slate-900">3. Submission Format</h2>
          <ul className="list-disc space-y-2 pl-6 text-slate-700">
        ...
        <section className="mb-10">
          <h2 className="font-display mb-4 border-b-2 border-blue-500 pb-2 text-3xl font-bold text-slate-900">4. Presentation Rules</h2>
          <ul className="list-disc space-y-2 pl-6 text-slate-700">
        ...
        <section className="mb-10">
          <h2 className="font-display mb-4 border-b-2 border-blue-500 pb-2 text-3xl font-bold text-slate-900">5. Judging Criteria</h2>
        ...
        <section className="mb-10">
          <h2 className="font-display mb-4 border-b-2 border-blue-500 pb-2 text-3xl font-bold text-slate-900">6. Ethics and Fair Play</h2>
          <ul className="list-disc space-y-2 pl-6 text-slate-700">
        ...
        <section className="mb-12">
          <h2 className="font-display mb-4 border-b-2 border-blue-500 pb-2 text-3xl font-bold text-slate-900">7. Safety and Conduct</h2>
          <ul className="list-disc space-y-2 pl-6 text-slate-700">
