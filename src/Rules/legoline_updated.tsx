...
const legoline = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="relative overflow-hidden bg-linear-to-r from-amber-900 via-amber-800 to-amber-900 py-20">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Contact Section */}
        <section className="rounded-2xl bg-linear-to-r from-amber-600 to-amber-800 p-8 text-center mt-12">
