...
const Drone = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="relative overflow-hidden bg-linear-to-r from-sky-900 via-sky-800 to-sky-900 py-20">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        {/* Contact Section */}
        <section className="rounded-2xl bg-linear-to-r from-sky-700 to-sky-900 p-8 text-center mt-12">
