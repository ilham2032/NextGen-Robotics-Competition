...
const LegoSumo = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative overflow-hidden bg-linear-to-r from-blue-600 via-blue-500 to-blue-600 py-20">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <section className="rounded-2xl bg-linear-to-r from-blue-500 to-blue-700 p-8 text-center mt-12">
