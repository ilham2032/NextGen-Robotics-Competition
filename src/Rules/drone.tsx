    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-20">
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center">
          <span className="inline-block rounded-full bg-slate-500/20 px-4 py-2 text-sm font-semibold text-slate-200 mb-4">
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        {/* Table of Contents */}
        <nav className="mb-12 rounded-2xl bg-slate-100 p-6 border border-slate-200">
          <h2 className="text-xl font-bold text-slate-900 mb-4">Contents</h2>
          <ol className="space-y-2 text-slate-700">
            <li><a href="#overview" className="hover:text-slate-900">1. Overview</a></li>
            <li><a href="#drone-specs" className="hover:text-slate-900">2. Drone Specifications</a></li>
            <li><a href="#course" className="hover:text-slate-900">3. Race Course</a></li>
            <li><a href="#race-rules" className="hover:text-slate-900">4. Race Rules</a></li>
            <li><a href="#scoring" className="hover:text-slate-900">5. Scoring System</a></li>
            <li><a href="#penalties" className="hover:text-slate-900">6. Penalties & Disqualification</a></li>
            <li><a href="#safety" className="hover:text-slate-900">7. Safety Guidelines</a></li>
          </ol>
        </nav>

        {/* Section 1: Overview */}
        <section id="overview" className="mb-12">
          <h2 className="font-display text-3xl font-bold text-slate-900 mb-6 pb-3 border-b-2 border-slate-600">
            1. Overview
          </h2>
          <div className="prose prose-lg max-w-none text-slate-700">
            ...
            <div className="bg-slate-100 border-l-4 border-slate-600 p-4 my-6">
              <p className="font-semibold text-slate-900">Competition Format</p>
              <p className="text-slate-700">Time trials with knockout rounds. Fastest times advance to finals.</p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">Frame Size (Wheelbase)</td>
                  <td className="p-4 text-slate-600">120mm - 250mm</td>
                </tr>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Weight (with battery)</td>
                  <td className="p-4 text-slate-600">No limit (recommended under 500g)</td>
                </tr>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">Motor Size</td>
                  <td className="p-4 text-slate-600">Up to 2306 or equivalent</td>
                </tr>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Propeller Size</td>
                  <td className="p-4 text-slate-600">Up to 5 inches</td>
                </tr>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">Battery</td>
                  <td className="p-4 text-slate-600">LiPo 3S-6S (11.1V - 22.2V)</td>
                </tr>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Video Transmitter</td>
                  <td className="p-4 text-slate-600">Max 25mW (VTX) - Race frequency bands only</td>
                </tr>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">FPV Camera</td>
                  <td className="p-4 text-slate-600">Any standard FPV camera (analog/digital)</td>
                </tr>
                <tr className="bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Receiver</td>
                  <td className="p-4 text-slate-600">Any protocol (ELRS, Crossfire, SBUS, etc.)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section id="course" className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <h3 className="text-xl font-semibold text-slate-900 mb-3">3.1 Course Layout</h3>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">3.2 Gate Requirements</h3>
        ...
        <section id="race-rules" className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <h3 className="text-xl font-semibold text-slate-900 mb-3">4.1 Race Format</h3>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">4.2 Race Procedure</h3>
            <ul className="list-disc pl-6 space-y-2">
        ...
        <section id="scoring" className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-slate-700">
            <table className="w-full border-collapse">
              ...
              <tbody>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">Lap Time</td>
                  <td className="p-4 text-slate-600">Primary ranking (lower is better)</td>
                </tr>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Gate Completion</td>
                  <td className="p-4 text-slate-600">All gates must be passed in order</td>
                </tr>
                <tr className="border-b border-slate-200">
                  <td className="p-4 font-semibold text-slate-700">Crash Penalty</td>
                  <td className="p-4 text-slate-600">+2 seconds per gate missed/skipped</td>
                </tr>
                <tr className="bg-slate-50">
                  <td className="p-4 font-semibold text-slate-700">Tiebreaker</td>
                  <td className="p-4 text-slate-600">Best single lap time</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* Contact Section */}
        <section className="rounded-2xl bg-gradient-to-r from-slate-700 to-slate-900 p-8 text-center">
          ...
          <Link
            to="/contact"
            className="inline-block rounded-lg bg-white px-8 py-3 font-semibold text-slate-700 hover:bg-slate-100 transition"
          >
            Contact Us
          </Link>
        </section>
