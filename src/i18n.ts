...
const resources = {
  ...
  az: {
    translation: {
      ...
      "View all regulations": "Bütün qaydaları görün",
      ...
      "RS Media Team": "RS Media Team",
      "Victory Group": "Victory Group",
      "About the competition": "Yarış haqqında",
      "Acceptance of Terms": "Şərtlərin Qəbulu",
      "At NextGen Robotics, students build autonomous systems that compete in dynamic arenas while developing technical skills, strategic thinking, and strong teamwork.": "NextGen Robotics-də tələbələr dinamik arenalarda yarışan muxtar sistemlər quraraq texniki bacarıqlar, strateji düşüncə və güclü komanda işi inkişaf etdirirlər.",
      "August 26-27 - Build, Battle, and Innovate": "26-27 Avqust - Qur, Döyüş və İnnovasiya Et",
      "Builds confidence in science, technology, and engineering skills.": "Elm, texnologiya və mühəndislik bacarıqlarında inam yaradır.",
      "Contact Information": "Əlaqə Məlumatları",
      "Contact the Partnership Team": "Əməkdaşlıq Komandası ilə Əlaqə",
      "Contact the team": "Komanda ilə əlaqə saxlayın",
      "Description of Service": "Xidmətin Təsviri",
      "Empowering the next generation of engineers and innovators through robotics competition": "Mühəndislər və innovatorların növbəti nəsilini robotik yarışma vasitəsilə gücləndirmək",
      "Event Starts In": "Tədbir Başlayır",
      "Experience": "Təcrübə",
      "Explore different competition categories": "Müxtəlif yarış kateqoriyalarını araşdırın",
      "Finalize the partnership agreement": "Əməkdaşlıq razılaşmasını yekunlaşdırın",
      "Find out how your organization can become an official partner or sponsor of the NextGen Robotics Competition.": "Təşkilatınızın NextGen Robot Texnikası Yarışmasının rəsmi tərəfdaşı və ya sponsoru necə ola biləcəyini öyrənin.",
      "For sponsorship or partnership inquiries, please contact our partnership team by email. We welcome interest from technology firms, educational institutions, foundations, and regional businesses seeking a strategic collaboration.": "Sponsorluq və ya əməkdaşlıq sorğuları üçün partnership komandamızla e-poçt vasitəsilə əlaqə saxlayın. Biz texnologiya şirkətlərinin, təhsil müəssisələrinin, fondların və regional bizneslərin strateji əməkdaşlığa marağını alqışlayırıq.",
      "Governing Law": "Tətbiq Olunan Qanun",
      "High school and university teams": "Lisey və universitet komandaları",
      "How can sponsors or volunteers contact the team?": "Sponsorlar və ya könüllülər komandaya necə müraciət edə bilər?",
      "How to Become a Partner": "Tərəfdaş Necə Olmaq Olar",
      "Impact": "Təsir",
      "Includes robotics, AI, and strategy categories": "Robototexnika, süni intellekt və strategiya kateqoriyalarını əhatə edir",
      "Information to include": "Daxil edilməli məlumatlar",
      "Intellectual Property": "Əqli Mülkiyyət",
      "Join Now": "İndi Qoşul",
      "Limitation of Liability": "Məsuliyyət Məhdudiyyəti",
      "Location": "Yer",
      "NextGen Robotics Competition is a premier STEM event designed to inspire young innovators through immersive robotics challenges, expert mentorship, and industry collaboration.": "NextGen Robot Texnikası Yarışması gənc innovatorları immersiv robototexnika çağırışları, ekspert mentorluğu və sənaye əməkdaşlığı ilə ilhamlandırmaq üçün aparıcı STEM tədbiridir.",
      "Offers hands-on challenges, technical coaching, and real-time scoring.": "Praktiki çağırışlar, texniki təlim və real vaxtda qiymətləndirmə təqdim edir.",
      "Once your inquiry is received, we will follow up with a formal proposal, terms, and the agreement required to confirm the partnership.": "Sorğunuz alındıqdan sonra mövcud seçimlər, sponsorluq tanınması və növbəti addımlar barədə məlumat vermək üçün sizə cavab verəcəyik.",
      "Organization name and industry": "Təşkilatın adı və sektoru",
      "Other Categories": "Digər Kateqoriyalar",
      "Our mission": "Missiyamız",
      "Our team is ready to help with registration, rule clarification, and sponsorship information.": "Komandamız qeydiyyat, qaydaların izahı və sponsorluq məlumatları ilə kömək etməyə hazırdır.",
      "Our team typically replies to partnership inquiries within 2 business days. If you need an urgent response, please include that note in your email subject line.": "Komandamız adətən əməkdaşlıq sorğularına 2 iş günü ərzində cavab verir. Təxirəsalınmaz cavab istəyirsinizsə, xahiş edirik e-poçt mövzusunda bunu qeyd edin.",
      "Partner with NextGen Robotics": "NextGen Robotics ilə Tərəfdaşlıq Edin",
      "Partnering with NextGen Robotics provides a valuable opportunity to support STEM development, increase brand visibility, and contribute to the growth of the robotics community.": "NextGen Robotics ilə əməkdaşlıq STEM inkişafını dəstəkləmək, marka görünürlüğünü artırmaq və robototexnika icmasının böyüməsinə töhfə vermək üçün dəyərli imkan təqdim edir.",
      "Partnership": "Əməkdaşlıq",
      "Please include your organization name, sponsorship interest, preferred level of engagement, and any questions regarding sponsor benefits and visibility.": "Zəhmət olmasa təşkilatınızın adını, sponsorluq marağınızı, iştirak səviyyəsi üstünlüyünüzü və sponsorluq faydaları ilə bağlı suallarınızı daxil edin.",
      "Preferred focus areas, such as event support, prizes, workshops, or promotional visibility": "Tədbir dəstəyi, mükafatlar, seminarlar və ya promosion görünüş kimi üstünlük verilən diqqət sahələri.",
      "Prepare your sponsorship inquiry": "Sponsorluq sorğunuzu hazırlayın",
      "Primary contact name, role, and email address": "Əsas əlaqə şəxsin adı, rolu və e-poçt ünvanı",
      "Registered Teams": "Qeydiyyatdan Keçmiş Komandalar",
      "Response timeline": "Cavab müddəti",
      "Review our sponsorship opportunities": "Sponsorluq imkanlarımızı nəzərdən keçirin",
      "Send your inquiry to the partnership team and we will provide details on available options, sponsorship recognition, and the next steps.": "Sorğunuzu əməkdaşlıq komandamıza göndərin və mövcud seçimlər, sponsorluq tanınması və növbəti addımlar barədə təfərrüatları təqdim edəcəyik.",
      "Sponsorship type or estimated support level": "Sponsorluq növü və ya təxmini dəstək səviyyəsi",
      "Start Up": "Start Up",
      "Students building robotics projects": "Robot texnikası layihələri hazırlayan tələbələr",
      "Submit your inquiry by email": "Sorğunuzu e-poçt vasitəsilə göndərin",
      "Team size: up to 4 members": "Komanda ölçüsü: 4 üzvə qədər",
      "Termination": "Ləğv",
      "Terms of Service": "Xidmət Şərtləri",
      "The event combines robotics, artificial intelligence, and engineering design into a professional competition experience that prepares participants for future STEM careers.": "Tədbir robototexnika, süni intellekt və mühəndislik dizaynını gələcək STEM karyeraları üçün iştirakçıları hazırlayan peşəkar bir yarışma təcrübəsində birləşdirir.",
      "To empower the next generation of innovators by creating educational opportunities that blend engineering, autonomy, and competitive teamwork.": "Mühəndislik, avtonomiya və rəqabətli komanda işi ilə birləşən təhsil imkanları yaradaraq növbəti nəsil innovatorları gücləndirmək.",
      "Use the Contact page to reach organizers. You can also apply as a volunteer using the registration link provided there.": "Təşkilatçılara çatmaq üçün Əlaqə səhifəsindən istifadə edin. Həmçinin orada təqdim olunan qeydiyyat linkindən istifadə edərək könüllü ola bilərsiniz.",
      "User Responsibilities": "İstifadəçi Məsuliyyətləri",
      "We host a competitive robotics event that emphasizes creativity, precision, and teamwork. Participants design, build, and test robots in a supportive, high-energy environment.": "Biz kreativliyi, dəqiqliyi və komanda işini vurğulayan bir rəqabətli robototexnika tədbiri keçiririk. İştirakçılar dəstəkləyici, yüksək enerjili mühitdə robotları dizayn edir, qurur və sınaqdan keçirirlər.",
      "We offer structured partnership packages for companies, educational organizations, and community sponsors interested in supporting robotics education and competitive events.": "Biz robototexnika təhsili və rəqabət tədbirlərini dəstəkləmək istəyən şirkətlər, təhsil təşkilatları və icma sponsorları üçün strukturlaşdırılmış əməkdaşlıq paketləri təklif edirik.",
      "What we do": "Biz nə edirik",
      "Who can join": "Kim qoşula bilər"
    }
  }
};
