  ...
  return (
    <section className="min-h-screen bg-linear-to-br from-blue-900 via-blue-700 to-cyan-500 px-6 py-24">
      <div className="mx-auto max-w-md rounded-3xl border border-white/30 bg-white p-8 shadow-2xl">
        <h1 className="text-sm font-semibold tracking-widest text-blue-600 uppercase">{t("Admin Login")}</h1>
        <p className="mt-3 text-sm text-slate-600">Sign in to manage teams and competition categories.</p>

        <form className="mt-7 space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="mb-2 block text-sm font-medium text-blue-900">{t("Username")}</label>
            <input
              type="text"
              value={username}
          ...
          <div>
            <label className="mb-2 block text-sm font-medium text-blue-900">{t("Password")}</label>
            <input
              type="password"
              value={password}
